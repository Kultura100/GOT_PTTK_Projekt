...
return [
    ...
    */
    ...
    'custom' => [
        'klient' => [
            'pesel_unique' => 'Istnieje już klient, dla którego :attribute ma podaną wartość',
            'email_unique' => 'Istnieje już klient, dla którego :attribute ma podaną wartość',
            'nr_telefonu_unique' => 'Istnieje już klient, dla którego :attribute ma podaną wartość'
        ],
        'pracownik' => [
            'pesel_unique' => 'Istnieje już pracownik, dla którego :attribute ma podaną wartość',
            'email_unique' => 'Istnieje już pracownik, dla którego :attribute ma podaną wartość',
            'nr_telefonu_unique' => 'Istnieje już pracownik, dla którego :attribute ma podaną wartość'
        ],
